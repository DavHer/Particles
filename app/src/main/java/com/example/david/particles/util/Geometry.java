...
public class Geometry {
    ...
    public static float distanceBetween(Point point, Ray ray){
        ...
        // The length of the cross gives the area of an imaginary parallelogram
        // having the two vectors as sides. A parallelogram can be thought of as
        // consisting of two triangles, so this is the same as twice the area of the triangle
        // defined by the two vectors.

        float areaOfTriangleTimesTwo = p1ToPoint.crossProduct(p2ToPoint).length();
        float lengthOfBase = ray.vector.length();

        // The area of the triangle is also equal to (base * height) / 2
